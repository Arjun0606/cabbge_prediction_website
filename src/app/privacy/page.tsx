...
export const metadata: Metadata = {
  ...
  description: "Cabbge's privacy policy — what we collect, what we don't, and exactly how your Kalshi API key is handled.",
    ...
    <main className="min-h-screen pt-32 pb-24 px-6">
      <article className="max-w-3xl mx-auto">
        ...
        <Section title="The short version">
          ...
          Your Kalshi API key is encrypted with AWS KMS the moment you submit it and is never
          stored in plaintext.
        </Section>
        ...
        <Section title="What we collect">
          <ul className="list-disc pl-5 space-y-2 text-[var(--color-text-secondary)]">
            ...
            <li><strong className="text-white">Your Kalshi API credentials</strong> — the access key ID and RSA private key you generate inside your Kalshi profile. Encrypted with AWS KMS before persistence; never stored in plaintext.</li>
        ...
        <Section title="How your API key is secured">
          When you submit your Kalshi API key, it travels over TLS to our backend
        ...
        <Section title="Third-party services we use">
          <ul className="list-disc pl-5 space-y-2 text-[var(--color-text-secondary)]">
            ...
            <li><strong className="text-white">Kalshi API</strong> — read-only access using your credentials.</li>
